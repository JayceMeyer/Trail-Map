...
}`;function D9(){const[t,e]=cr.useState(null),n=r=>{console.log("Received clicked feature: ",r)},i=r=>{e(r)};return Oe.jsxs(Oe.Fragment,{children:[Oe.jsx("p",{className:"header-text",children:"NPMapTrail with Vite"}),Oe.jsxs("div",{className:"map-container",children:[Oe.jsxs("div",{className:"left-side",children:[Oe.jsx("div",{style:{display:"flex",flexDirection:"row"},children:Oe.jsx("img",{src:Ry,className:"logo",alt:"Vite logo"})}),Oe.jsx("button",{onClick:()=>i(zm),style:{padding:"20px",marginRight:"10px"},children:"Example of manually showing popup of feature"})]}),Oe.jsx(S9,{trailDataUrl:T9,trailAlertsUrl:P9,featurePopupToShow:t,elementClicked:n,mapCssHeight:"100%",mapCssWidth:"100%",enableTrailAlerts:!0,enableTrailAlertsToggle:!0,enableElevationProfile:!0})]})]})}ag(document.getElementById("root")).render(Oe.jsx(cr.StrictMode,{children:Oe.jsx(D9,{})}));
